...
public class MappedPageTest {
	...
	private String testDir = TestUtil.TEST_BASE_DIR + "bigmap/unit/mapped_page_test";

	@Test
	public void testSingleThread() throws IOException {
		int pageSize = 1024 * 1024 * 32;
		mappedPageFactory = new MappedPageFactoryImpl(pageSize, testDir + "/test_single_thread");
	...
	public void testMultiThreads() {
		int pageSize = 1024 * 1024 * 32;
		mappedPageFactory = new MappedPageFactoryImpl(pageSize, testDir + "/test_multi_threads");
