...
import edu.berkeley.cs162.TPCMaster.SlaveInfo;
...
public class TPCMasterTest {
	...
	public void setUp() throws Exception {
		...
		SocketServer kvServer = new RobustSocketServer(
				InetAddress.getLocalHost().getHostAddress(), 8899);
	...
	private void setUpSlave(String name) throws UnknownHostException, IOException, KVException {
		...
		SocketServer slave =
				new RobustSocketServer(InetAddress.getLocalHost().getHostAddress(), 9089);
	...
	public class RobustSocketServer extends SocketServer {
		...
		public void connect() throws IOException {
			server = new ServerSocket(this.port);//knew it
	...
	//test the slaveServer works~
	 @Test
	    public void slaveServercheck() throws KVException {
//	    	TPCMaster tpc = new TPCMaster(1);
//	    	SlaveInfo temp = tpc.getSlaveTest();
//	    	assertEquals("1000L",temp.slaveID);
//	    	assertEquals("vib",temp.hostName);
//	    	assertEquals("8090",temp.port);
	...
	public void testPutGet() throws InterruptedException, KVException, UnknownHostException {
		...
		KVClient client = new KVClient(InetAddress.getLocalHost().getHostAddress(), 9988);
