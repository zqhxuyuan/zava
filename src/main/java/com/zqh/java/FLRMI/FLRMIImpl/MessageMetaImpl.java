package com.zqh.java.FLRMI.FLRMIImpl;


import com.zqh.java.FLRMI.FLRMIException;
import com.zqh.java.FLRMI.FLRMISerizableCenter;
import com.zqh.java.FLRMI.MessageMeta;
import com.zqh.java.FLRMI.SerizableMessageMeta;
...
public class MessageMetaImpl implements MessageMeta {
    ...
    private static final String[] SE_MESSAGE_METAS = new String[] {
            "com.zqh.java.FLRMI.FLRMIImpl.XMLSerizableMessageMetaImpl",
            "com.zqh.java.FLRMI.FLRMIImpl.SimpleSerizableMessageMetaImpl" };
