...
import com.github.netcomm.sponge.FilePersistence;
import com.github.netcomm.sponge.SpongeArrayBlockingQueue;
import com.github.netcomm.sponge.SpongeService;
...
public class TestThread {
    ...
    public static void main(String agrs[]) {
        try {
            String tmpDir = "/tmp/";
            if (agrs.length > 0) tmpDir = agrs[0];
