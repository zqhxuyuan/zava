...
```bash
mvn compile exec:java -Dexec.mainClass=NoPublishDemo
```
...
```bash
mvn compile exec:java -Dexec.mainClass=InvalidLongDemo
```
...
```bash
mvn compile exec:java -Dexec.mainClass=HashMapHangDemo
```
...
```bash
mvn compile exec:java -Dexec.mainClass=WrongCounterDemo
```
...
```bash
mvn compile exec:java -Dexec.mainClass=SynchronizationOnMutableFieldDemo
```
...
```bash
mvn compile exec:java -Dexec.mainClass=SymmetricLockDeadlockDemo
```
