 ...
 */
public class TQ42_KImportantString {
    ...
    public static void main(String[] args){
        ...
        String kstr = TQ42_KImportantString.find(strs, 3, 1);
        System.out.println(kstr); //abc
        kstr = TQ42_KImportantString.find(strs, 3, 2);
        System.out.println(kstr); //abcf
        kstr = TQ42_KImportantString.find(strs, 3, 3);
        System.out.println(kstr); //abcfabc

        strs = new String[] {"abc", "cde", "bcf", "def"};
        kstr = TQ42_KImportantString.find(strs, 3, 3);
        System.out.println(kstr); //abcdef
    }
}
