 ...
 *
 */
public class TQ22_CountSubSetRelations {

    public static Pair<Integer> count(int N) {
        int[] r1s = new int[N + 1];
        int[] r2s = new int[N + 1];
        r1s[1] = 0;
        r2s[1] = 0;
        ...
        return new Pair<>(r1s[N], r2s[N]);
    }

    public static void main(String[] args){
        Pair<Integer> relations = TQ22_CountSubSetRelations.count(3);
        System.out.println("relation1: " + relations.x);
        System.out.println("relation2: " + relations.y);
    }
}
